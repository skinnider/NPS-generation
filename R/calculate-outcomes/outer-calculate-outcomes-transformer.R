# Calculate outcomes for transformer-based models of SMILES or SELFIES strings.
setwd("~/git/invalid-smiles-analysis")
options(stringsAsFactors = FALSE)
library(argparse)

# parse arguments
parser = ArgumentParser(prog = 'outer-calculate-outcomes-transformer.R')
...
model_dir = with(grid, file.path(base_dir, 'models'))
