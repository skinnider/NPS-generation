...
# parse arguments
parser = ArgumentParser(prog = 'outer-tabulate-molecules-gdb13.R')
...
# define input files
train_dir = file.path(base_dir, "GDB13", "inputs")
...
sh_file = 'sh/tabulate-molecules/tabulate-molecules-gdb13.sh'
sh_dir = dirname(sh_file)
if (!dir.exists(sh_dir)) 
  dir.create(sh_dir, recursive = TRUE)
write_sh(job_name = 'tabulate-gdb13',
         sh_file = sh_file,
         grid_file = grid_file,
