# First step of summarizing the structural prior:
# Compute % ever generated, top-k accuracy curves, and top-1 Tc, summarizing
# over CV folds.
# Do this either: 
...
# parse arguments
parser = ArgumentParser(prog = 'outer-summarise-structural-prior.R')
