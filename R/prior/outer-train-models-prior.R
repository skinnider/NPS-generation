# Train RNN models on the prior datasets.
setwd("~/git/invalid-smiles-analysis")
options(stringsAsFactors = FALSE)
library(argparse)

# parse arguments
parser = ArgumentParser(prog = 'outer-train-models-prior.R')
...
sh_file = 'sh/train-models/train-models-prior.sh'
sh_dir = dirname(sh_file)
if (!dir.exists(sh_dir)) 
  dir.create(sh_dir, recursive = TRUE)
write_sh(job_name = 'train-models-prior',
         sh_file = sh_file,
         grid_file = grid_file,
