# Evaluate the validity of SMILES generated by recurrent neural network models.
setwd("~/git/invalid-smiles-analysis")
options(stringsAsFactors = FALSE)
library(argparse)

# parse arguments
parser = ArgumentParser(prog = 'outer-parse-valid-SMILES-RNN.R')
...
grid_file = "sh/grids/parse-valid-SMILES.txt"
...
sh_file = 'sh/sample-molecules/parse-valid-SMILES.sh'
sh_dir = dirname(sh_file)
if (!dir.exists(sh_dir)) 
  dir.create(sh_dir, recursive = TRUE)
write_sh(job_name = 'parse-valid-SMILES',
         sh_file = sh_file,
         grid_file = grid_file,
         inner_file = 'python/inner-parse-valid-SMILES.py',
         system = system,
         time = 24,
         mem = 24)
