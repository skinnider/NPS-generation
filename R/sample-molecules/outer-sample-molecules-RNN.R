# Sample generated molecules from recurrent neural network-based models of 
...
# parse arguments
parser = ArgumentParser(prog = 'outer-sample-molecules-RNN.R')
...
sh_file = 'sh/sample-molecules/sample-molecules-RNN.sh'
...
write_sh(job_name = 'sample-molecules-RNN',
         sh_file = sh_file,
         grid_file = grid_file,
         inner_file = 'python/inner-sample-molecules-RNN.py',
         system = system,
         time = 24,
         mem = 12,
         gpu = TRUE)
